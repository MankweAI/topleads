...
const pageConfig = {
  ...
  title: "For Electricians: Stop Leaking R15,000/Month",
  description:
    "Your electrical business is losing jobs to competitors. Our 'No-BS' audit finds the 3 leaks in your online presence (Maps, Reviews, and Missed Enquiries) in under 30 seconds.",
  videoPlaceholder: "AI Specialist Video: 3 Leaks Costing Electricians Money",
  calculatorConfig: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        options: [
          { value: "not_enough_calls", label: "Not enough phone calls" },
          {
            value: "bad_reviews",
