...
const pageConfig = {
  industry: "plumbers",
  title: "For Plumbers: Stop Leaking R20,000/Month",
  description:
    "Your plumbing business is losing money to competitors. Our 'No-BS' audit finds the 3 leaks in your online presence (Maps, Reviews, and Missed Calls) in under 30 seconds.",
  videoPlaceholder: "AI Specialist Video: 3 Leaks Costing Plumbers Money",
  calculatorConfig: {
