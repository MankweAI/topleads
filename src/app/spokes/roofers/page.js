...
const pageConfig = {
  industry: "roofers",
  title: "For Roofers: Stop Leaking High-Value Leads",
  description:
    "Your roofing company is losing jobs to competitors. Our 'No-BS' audit finds the 3 leaks in your online presence (Maps, Reviews, and Missed Enquiries) in under 30 seconds.",
  videoPlaceholder: "AI Specialist Video: 3 Leaks Costing Roofers Money",
  calculatorConfig: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        options: [
          { value: "not_enough_calls", label: "Not enough quote requests" },
          {
            value: "bad_reviews",
